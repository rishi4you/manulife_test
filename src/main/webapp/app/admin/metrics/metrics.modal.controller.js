(function() {
    ...
    angular
        ...
        .controller('CgMetricsMonitoringModalController', CgMetricsMonitoringModalController);

    CgMetricsMonitoringModalController.$inject = ['$uibModalInstance', 'threadDump'];

    function CgMetricsMonitoringModalController ($uibModalInstance, threadDump) {
        var vm = this;
